...
### Released
- Published **incident-handoff-broker** as a public, portfolio-grade system focused on platform governance.
...
### Shipped
- Cut the first coherent internal version of **incident-handoff-broker** with stable domain objects, review surfaces, and decision outputs.
